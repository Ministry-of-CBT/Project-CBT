...
event_manager.listen { MaterialEvent event ->
    ...
    new Material.Builder(28001, "methamphetamine")
        .fluid()
        .color(0xaffff6)
      ...
      new Material.Builder(28002, "chloroacetone")
        .fluid()
        .color(0xffbf00)
      ...
      new Material.Builder(28003, "aluminium_trichloride")
        .dust().fluid()
        .color(0xd3d3d3)
      ...
      new Material.Builder(28004, "methylamine")
      ...
      new Material.Builder(28005, "phenylacetone")
        .fluid()
        .color(0xffffff)
      ...
      new Material.Builder(28006, "lithium_aluminium_hydride")
        .dust()
        .color(0xa9a9a9)
      ...
      new Material.Builder(28007, "lithium_hydride")
        .dust()
        .color(0x72a38c)
        .components(material('lithium') * 1, material('hydrogen') * 1)
        .build()
  
      new Material.Builder(28008, "lithium_chloride")
        .dust()
        .color(0xffffff)
